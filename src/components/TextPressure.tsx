...
const TextPressure = ({
    ...
    const animate = () => {
      ...
      if (titleRef.current) {
        ...
        spansRef.current.forEach(span => {
          ...
          // @ts-ignore - font-variation-settings is not typed on style
  ...
  const rootClass = 'text-pressure-root';
  ...
  return (
    ...
    >
      <style>{`
        ...
        .${rootClass} .tp-stroke span {
          position: relative;
          color: ${textColor};
        }
        .${rootClass} .tp-stroke span::after {
